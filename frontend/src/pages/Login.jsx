...
export default function LoginBody() {
    ...
    return (
        ...
        <div className="w-full max-w-sm bg-muted/10 border border-muted rounded-2xl p-6 shadow-md">
            ...
            <input
                ...
                className="p-3 rounded-lg bg-background border border-primary focus:outline-none focus:ring-2 focus:ring-primary"
                required
            />
            ...
            <div className="relative">
                ...
                className="w-full p-3 rounded-lg bg-background border border-primary focus:outline-none focus:ring-2 focus:ring-primary pr-10"
                required
                />
                <button
                type="button"
            ...
            <button
                type="submit"
                className="p-3 rounded-lg bg-primary text-background font-semibold hover:opacity-90 transition"
            >
                Log In
            </button>
            </form>
